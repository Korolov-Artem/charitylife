...
const ArticlesThemes = () => {
  ...
  const { data, isLoading, error, isFetching } = useGetArticlesByThemeQuery({
    theme: currentId,
    page: page,
  });
  ...
  return (
    <div className="flex flex-col border-b-[1vh] ml-[-40vw]">
      <div className="flex mt-[30vh] text-4xl ml-[45vw] tracking-[0.2rem]underline-offset-8">
        <div
      ...
      <div className="flex justify-between mt-[24vh] ml-[22vw]">
        {articles && articles.length > 0 ? (
          <ArticlesByTheme articles={articles} />
        ) : (
          <div className="text-5xl ml-[30vw] mb-[15vh]">
            Покищо, тут порожньо...
          </div>
        )}
      ...
      {articles && articles.length > 0 ? (
        <div className="flex ml-[50vw] mt-[-2vh] text-6xl items-center gap-[5vw]">
          <button
            onClick={handlePrev}
