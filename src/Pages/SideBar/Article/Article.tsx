...
const Article: React.FC<ArticleProps> = ({data, count}) => {
    return (
        <div
            className={`flex flex-col ${count < 4 ? "border-b-2 border-black" : " "}  max-w-sm mt-8 ml-4 items-start overflow-hidden text-ellipsis break-words text-left font-serif text-lg`}>
